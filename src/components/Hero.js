...
const Hero = () => {
  return (
    <div className="container h-[90vh] flex justify-between items-center mx-auto px-8 md:px-24 lg:px-24 w-full">
      <div className="flex flex-wrap md:flex-nowrap">
        ...
        <img
          className="object-cover left-3 md:w-full md:h-full md:absolute md:top-6 md:left-60 xl:w-3/4 xl:left-96 2xl:w-1/2 2xl:left-96 2xl:ml-96 -z-1 "
          src={headshot}
          alt=""
        />
      </div>
